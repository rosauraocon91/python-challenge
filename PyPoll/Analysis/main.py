...
path = r"C:\Users\rosau\nuclass\NU-VIRT-DATA-PT-11-2021-U-C\02-Homework\03-Python\Instructions\PyPoll\Resources\election_data.csv"

#Start csv file handling
open ('election_data.csv') as csvfile: 
...
file1=open("Analysis/pypoll.txt","w") #Open or if file does not exist then create file named pypoll.txt
